...
-l"C:\Users\Administrator\Desktop\msc project\ccs_program\openmp_debug_release_section_correct_0818\OpenMP_Parallel\Release\configPkg\package\cfg\omp_config_pe66.oe66"
-l"C:\ti\uia_1_02_00_07\packages\ti\uia\services\lib\release\ti.uia.services.ae66"
-l"C:\ti\uia_1_02_00_07\packages\ti\uia\sysbios\lib\release\ti.uia.sysbios.ae66"
-l"C:\ti\uia_1_02_00_07\packages\ti\uia\runtime\lib\release\ti.uia.runtime.ae66"
-l"C:\ti\uia_1_02_00_07\packages\ti\uia\family\c66\lib\release\ti.uia.family.c66.ae66"
...
-l"C:\ti\uia_1_02_00_07\packages\ti\uia\events\lib\release\ti.uia.events.ae66"
...
MEMORY
{
    ...
    MSMCSRAM : org = 0xc000000, len = 0x3c0000
    MSMCSRAM_NOCACHE : org = 0xa03c0000, len = 0x40000
}
...
SECTIONS
{
    ...
    GROUP: load > MSMCSRAM, run > MSMCSRAM, table(BINIT)
    {
        .neardata:
        .fardata:
    }
     ...
     * defailt placement.
     */
    .TI.tls:       load   >   MSMCSRAM
    .TI.tls_init:  load   >   MSMCSRAM
...
SECTIONS
{
    ti.sdo.ipc.SharedRegion_0:  { . += 0x25000;} run > 0xa03c0000, type = NOLOAD
    ti.sdo.ipc.SharedRegion_1:  { . += 0x80000;} run > 0xc000000, type = NOLOAD
...
SECTIONS
{
    ...
    .fardata:Left: load > DDR3
    .fardata:Right: load > DDR3
    .MSMC0: load > DDR3
    .vecs: load > MSMCSRAM
